...
from Encryption.Algorithms.AES.Util import get_aes_key_data, get_encoded_bytes, get_decoded_string, bytes_to_string, string_to_bytes


text = 'Encrypt this!'
password = 'admin123'
key, salt = get_aes_key_data(password)
